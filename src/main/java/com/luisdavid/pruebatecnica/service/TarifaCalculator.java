 ...
 * del reloj, no muta estado externo. Recibe entradas explicitas y devuelve un
 * {@link CalculoTarifa} inmutable. Esto la convierte en la pieza mas facil de
 * testear y la mas sensible: aqui esta toda la logica monetaria del sistema.</p>
 *
 ...
 *       igual a {@code 50% × tarifa × horasRetraso}. El retraso minimo facturable
...
public class TarifaCalculator {
    ...
    /** Factor de multa segun RN-03: 50% de la tarifa por hora. */
     ...
     * @param horaFin               hora real de devolucion
     * @param duracionEstimadaHoras duracion estimada que el cliente declaro al iniciar
    ...
    public CalculoTarifa calcular(
        ...
        if (!horaFin.isAfter(horaInicio)) {
            throw new IllegalArgumentException("La hora de devolucion debe ser posterior a la de inicio");
        }
     ...
     *
     * <p>Devuelve 0 si el uso real no excedio la estimacion. En caso de exceder,
     * el retraso se redondea al alza y se asegura un minimo de 1 hora.</p>
     */
