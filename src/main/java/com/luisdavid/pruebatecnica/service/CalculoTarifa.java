...
/**
 * Resultado inmutable del calculo de tarifa para un alquiler finalizado.
 *
 * <p>Se modela como {@code record} para garantizar inmutabilidad y reducir boilerplate.
 * Separa los componentes (base, multa) ademas del total, de modo que el llamador
 * pueda mostrar el desglose al cliente y persistirlo en la entidad.</p>
 *
 * @param costoBase         costo por horas reales de uso (RN-02)
 * @param multa             penalizacion por devolucion tardia (RN-03), cero si no aplica
